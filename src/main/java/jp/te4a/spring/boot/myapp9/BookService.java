...
public class BookService {
	...
	public void delete(Integer id) {
		BookBean bookBean = new BookBean();
		bookBean.setId(id);
//		BeanUtils.copyProperties(a, bookBean);
//		bookBean.setPrice(a.getPrice());
//		bookBean.setPublisher(a.getPublisher());
//		bookBean.setTitle(a.getTitle());
//		bookBean.setWritter(a.getWritter());
	...
	public BookForm findOne(Integer id) {
		...
		//BookBean bookBean = bookRepository.findById(int);
